...
/**
 * Full-state payload shared by created/updated events published by the
 * command-side service. Field names deliberately mirror the aggregate so
 * projection mapping is a property copy.
 */
@Getter
@Setter
@NoArgsConstructor
@JsonIgnoreProperties(ignoreUnknown = true)
public abstract class LoanProposalEventPayload extends Event {
